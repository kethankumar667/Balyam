...
/**
 * Rematch seating: whoever sat second last game moves first this game, so the
 * host stops getting X (and the opening move) in every rematch. Players who
 * have left are dropped; anyone new keeps their relative order at the end.
 */
