...
const SEED_CATALOG: CosmeticCatalogItem[] = [
  ...
  { id: "table_crt_neon_90s", category: "TABLE_THEME", name: "CRT Cyber Neon 90s", description: "Retro gridlines, arcade CRT glow, and synthwave backdrop.", priceCoins: 2500, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 20 },
  { id: "table_royal_mahogany", category: "TABLE_THEME", name: "Royal Mahogany Lounge", description: "Polished mahogany wood grain with regal gold-leaf flourishes.", priceCoins: 5000, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 30 },
  { id: "table_midnight_velvet", category: "TABLE_THEME", name: "Midnight Velvet", description: "Deep sapphire blue velvet with soft ambient silver sheen.", priceCoins: 1200, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 40 },
  ...
  { id: "aura_radiant_vanguard", category: "AVATAR_AURA", name: "Radiant Vanguard Aura", description: "Solar sunburst golden ring softly pulsing around your profile.", priceCoins: 4000, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 20 },
  { id: "aura_ludo_king", category: "AVATAR_AURA", name: "Royal Monarch Halo", description: "Crimson and gold dual orbiting planetary rings.", priceCoins: 6000, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 30 },
  { id: "aura_rummy_maestro", category: "AVATAR_AURA", name: "Arcane Emerald Shimmer", description: "Glowing emerald runes floating in a hypnotic ambient swirl.", priceCoins: 3500, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 40 },
  ...
  { id: "title_early_bird", category: "PODIUM_TITLE", name: "Early Bird", description: "Earned by completing a 7-day daily login streak.", priceCoins: 0, rarity: "RARE", unlockMethod: "STREAK_MILESTONE", isActive: true, displayOrder: 20 },
  { id: "title_table_master", category: "PODIUM_TITLE", name: "Table Master", description: "Recognized veteran of the BHALYAM lounge tables.", priceCoins: 2500, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 30 },
  { id: "title_grandmaster", category: "PODIUM_TITLE", name: "Grandmaster", description: "Elite lounge title displayed on victory podiums and player lists.", priceCoins: 10000, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 40 },
];
