...
const SEED_CATALOG: CosmeticCatalogItem[] = [
  ...
  { id: "token_neon_ring", category: "TOKEN_SKIN", name: "Cyber Pulse Ring", description: "Neon ring hovering around the base of the player token.", priceCoins: 1500, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 40 },
  ...
  { id: "token_finish_polished_pearl", category: "TOKEN_SKIN", name: "Polished Pearl", description: "Ultra-glossy hand-polished pawn with a luminous sheen.", priceCoins: 1800, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 70 },
  { id: "token_finish_carved_grain", category: "TOKEN_SKIN", name: "Carved Grain", description: "Fine hand-carved grain striations across a solid pawn.", priceCoins: 2000, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 80 },
  { id: "token_finish_matte_noir", category: "TOKEN_SKIN", name: "Matte Noir", description: "Sleek low-gloss matte finish with a minimalist trim.", priceCoins: 1700, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 90 },
  { id: "token_finish_rose_glass", category: "TOKEN_SKIN", name: "Rose Glass", description: "Soft translucent glass pawn with a gentle inner glow.", priceCoins: 2200, rarity: "RARE", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 100 },
  ...
  { id: "token_finish_veined_marble", category: "TOKEN_SKIN", name: "Veined Marble", description: "Polished stone finish threaded with fine natural veins.", priceCoins: 3600, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 140 },
  ...
  { id: "token_finish_nebula_swirl", category: "TOKEN_SKIN", name: "Nebula Swirl", description: "Deep cosmic gradient scattered with twinkling sparkle dust.", priceCoins: 5000, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: false, displayOrder: 180 },
  ...
  // Token Skins — character-themed accessories (2026-09-15). Icon carries
  // fixed signature colors; the pawn body stays seat-colored.
  { id: "token_theme_ninja", category: "TOKEN_SKIN", name: "Shadow Ninja", description: "A steel shuriken badge for the stealthiest player at the table.", priceCoins: 3200, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 200 },
  { id: "token_theme_thunder_hammer", category: "TOKEN_SKIN", name: "Thunder Hammer", description: "A warrior's mallet crackling with a small bolt of lightning.", priceCoins: 3600, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 210 },
  { id: "token_theme_super_hero", category: "TOKEN_SKIN", name: "Super Hero", description: "A flowing cape and a golden star emblem for the table's champion.", priceCoins: 4200, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 220 },
  { id: "token_theme_arcane_wizard", category: "TOKEN_SKIN", name: "Arcane Wizard", description: "A pointed hat and a trail of golden sparkles for the board's spellcaster.", priceCoins: 3400, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 230 },
  { id: "token_theme_star_voyager", category: "TOKEN_SKIN", name: "Star Voyager", description: "A frosted helmet visor and drifting stars for an explorer of distant lanes.", priceCoins: 3000, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 240 },
  { id: "token_theme_dragon_knight", category: "TOKEN_SKIN", name: "Dragon Knight", description: "Angular wing spikes framing an emerald-and-bronze shield emblem.", priceCoins: 4800, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 250 },
  { id: "token_theme_pirate_captain", category: "TOKEN_SKIN", name: "Pirate Captain", description: "A wide tricorn hat above a skull-and-crossbones badge.", priceCoins: 3300, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 260 },
  { id: "token_theme_cyber_bot", category: "TOKEN_SKIN", name: "Cyber Bot", description: "A glowing cyan visor band and a blinking antenna light.", priceCoins: 3100, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 270 },
  { id: "token_theme_samurai", category: "TOKEN_SKIN", name: "Samurai", description: "A gilded kabuto crescent crest and a katana hilt at the hip.", priceCoins: 4000, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 280 },
  { id: "token_theme_vampire_count", category: "TOKEN_SKIN", name: "Vampire Count", description: "A popped black collar and a small crimson bat-wing badge.", priceCoins: 3800, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 290 },
  { id: "token_theme_desert_sultan", category: "TOKEN_SKIN", name: "Desert Sultan", description: "A draped ivory turban set with a crescent-and-gem front piece.", priceCoins: 4400, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 300 },
  { id: "token_theme_arctic_ranger", category: "TOKEN_SKIN", name: "Arctic Ranger", description: "A scalloped fur hood trim and an icy snowflake badge.", priceCoins: 2800, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 310 },
  { id: "token_theme_steam_inventor", category: "TOKEN_SKIN", name: "Steam Inventor", description: "Brass goggles with glass-blue lenses and a small clockwork gear.", priceCoins: 3500, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 320 },
  { id: "token_theme_jungle_scout", category: "TOKEN_SKIN", name: "Jungle Scout", description: "A leaf headband above a brass compass badge with a red needle.", priceCoins: 2600, rarity: "EPIC", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 330 },
  { id: "token_theme_imperial_general", category: "TOKEN_SKIN", name: "Imperial General", description: "A sweeping navy plume crest and a gold medal on a crimson ribbon.", priceCoins: 4600, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 340 },
  { id: "token_theme_void_reaper", category: "TOKEN_SKIN", name: "Void Reaper", description: "A deep hood with a faint violet glow and a small silver scythe.", priceCoins: 5200, rarity: "LEGENDARY", unlockMethod: "COIN_PURCHASE", isActive: true, displayOrder: 350 },
