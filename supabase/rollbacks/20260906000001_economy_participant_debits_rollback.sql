-- ═══════════════════════════════════════════════════════════════════════
-- Economy V1 — Rollback Per-Participant Debits Support in commit_match_entry
-- ═══════════════════════════════════════════════════════════════════════
--
-- Rollback for: 20260906000001_economy_participant_debits.sql
-- Restores commit_match_entry to the 7-parameter signature established in
-- 20260829000000_economy_seat_capacity_contract.sql.

drop function if exists public.commit_match_entry(text, text, text, integer, integer, integer, boolean, jsonb);
