  ...
  return (
    ...
    >
      <div className="p-6 space-y-6">
        {error && (
          <div className="p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 text-xs text-red-700 dark:text-red-400 flex items-start gap-2">
        ...
        {settlement ? (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3.5 rounded-xl bg-[var(--chrome-panel)] border border-[var(--chrome-border)] shadow-2xs">
              <span className="text-[10px] font-bold text-[var(--chrome-ink-soft)] uppercase block">Room Code</span>
              <span className="font-mono font-bold text-sm text-[var(--chrome-ink)]">{settlement.roomCode || "—"}</span>
            </div>

            <div className="p-3.5 rounded-xl bg-[var(--chrome-panel)] border border-[var(--chrome-border)] shadow-2xs">
              <span className="text-[10px] font-bold text-[var(--chrome-ink-soft)] uppercase block">Seats</span>
              <span className="font-mono font-bold text-sm text-[var(--chrome-ink)]">
        ...
        {settlement && (
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-2xl bg-[var(--chrome-panel)] border border-[var(--chrome-border)] shadow-2xs flex items-center justify-between text-xs">
              <div className="space-y-0.5">
                <span className="font-mono font-bold text-[var(--chrome-ink)] block">{settlement.hostIdentityId}</span>
