...
const RAW_PUBLIC_ROUTES_METADATA: Record<string, RouteMetadata> = {
  ...
  "/reviews/write": {
    path: "/reviews/write",
    title: "Write a Review | BHALYAM",
    description:
      "Share your experience with BHALYAM or a specific game — star rating plus your own words, read by real players.",
    keywords: ["bhalyam review", "rate bhalyam", "game review", "player feedback", "write a review"],
    canonical: `${BASE_URL}/reviews/write`,
    ogTitle: "Write a Review | BHALYAM",
    ogDescription: "Tell other players what you think of BHALYAM, or of a specific game.",
    ogImage: DEFAULT_OG_IMAGE,
    ogType: "website",
    twitterCard: "summary_large_image",
    twitterTitle: "Write a Review | BHALYAM",
    twitterDescription: "Share a star rating and a few words about your BHALYAM experience.",
    twitterImage: DEFAULT_OG_IMAGE,
  },
  "/feedback": {
    path: "/feedback",
    title: "Leave us Feedback | BHALYAM",
    description:
      "Found a bug or have an idea? Send feedback straight to the BHALYAM team — bug reports, suggestions, or anything else.",
    keywords: ["bhalyam feedback", "report a bug", "suggest a feature", "bhalyam suggestions"],
    canonical: `${BASE_URL}/feedback`,
    ogTitle: "Leave us Feedback | BHALYAM",
    ogDescription: "Bug reports and suggestions, read by the team that builds BHALYAM.",
    ogImage: DEFAULT_OG_IMAGE,
    ogType: "website",
    twitterCard: "summary_large_image",
    twitterTitle: "Leave us Feedback | BHALYAM",
    twitterDescription: "Found a bug or have an idea? Tell the BHALYAM team directly.",
    twitterImage: DEFAULT_OG_IMAGE,
  },
  "/testimonials": {
    path: "/testimonials",
    title: "Player Testimonials | BHALYAM",
    description:
      "Real reviews from the BHALYAM community — see what players are saying before you join a table.",
    keywords: ["bhalyam reviews", "bhalyam testimonials", "player reviews", "bhalyam community"],
    canonical: `${BASE_URL}/testimonials`,
    ogTitle: "What Players Say | BHALYAM Testimonials",
    ogDescription: "Real reviews from the BHALYAM community.",
    ogImage: DEFAULT_OG_IMAGE,
    ogType: "website",
    twitterCard: "summary_large_image",
    twitterTitle: "Player Testimonials | BHALYAM",
    twitterDescription: "See what real players are saying about BHALYAM.",
    twitterImage: DEFAULT_OG_IMAGE,
  },
  "/terms": {
    path: "/terms",
  ...
  "/2048": {
    path: "/2048",
    title: "2048 Game Online | Play Classic Tile Sliding Number Puzzle — BHALYAM",
    description:
      "Play 2048 online for free. Slide numbered tiles across the 4x4 grid, merge numbers, and unlock Battle, Race, Time Attack, and Zen modes with zero ads.",
    keywords: [
      "2048 game online",
      "play 2048 browser",
      "tile sliding puzzle",
    ...
    ogTitle: "2048 Game Online | Sliding Number Puzzle — BHALYAM",
    ogDescription:
      "Slide tiles, merge numbers, and reach the legendary 2048 tile. Play solo or test your speed in race and time attack modes.",
    ogImage: DEFAULT_OG_IMAGE,
    ogImageWidth: DEFAULT_OG_WIDTH,
    ogImageHeight: DEFAULT_OG_HEIGHT,
    ogImageType: DEFAULT_OG_TYPE,
    ogImageAlt: "2048 Tile Sliding Game Board",
    ogSiteName: DEFAULT_SITE_NAME,
    ogLocale: DEFAULT_LOCALE,
    ogType: "game",
    twitterCard: "summary_large_image",
    twitterSite: DEFAULT_TWITTER_HANDLE,
    twitterCreator: DEFAULT_TWITTER_HANDLE,
    twitterTitle: "2048 Game Online | Sliding Number Puzzle — BHALYAM",
    twitterDescription: "Slide tiles, merge matching numbers, and reach the 2048 tile in your browser.",
    twitterImage: DEFAULT_OG_IMAGE,
    twitterImageAlt: "2048 Tile Sliding Game Board",
  },
  "/sudoku": {
    path: "/sudoku",
    title: "Sudoku Cyber-Matrix | Free Online Logic Number Puzzle — BHALYAM",
    description:
      "Play free online Sudoku with futuristic Cyber-Matrix aesthetics. Choose from Easy, Medium, Hard, and Expert boards with intelligent hints and instant validation.",
    keywords: [
      "sudoku online free",
      "daily sudoku puzzle",
      "sudoku browser game",
    ...
    ogTitle: "Sudoku Cyber-Matrix | Free Online Logic Number Puzzle — BHALYAM",
    ogDescription:
      "Play neural 9x9 Sudoku logic puzzles with futuristic design, notes mode, intelligent hints, and error checking.",
    ogImage: DEFAULT_OG_IMAGE,
    ogImageWidth: DEFAULT_OG_WIDTH,
    ogImageHeight: DEFAULT_OG_HEIGHT,
    ogImageType: DEFAULT_OG_TYPE,
    ogImageAlt: "Sudoku Cyber-Matrix Game Board",
    ogSiteName: DEFAULT_SITE_NAME,
    ogLocale: DEFAULT_LOCALE,
    ogType: "game",
    twitterCard: "summary_large_image",
    twitterSite: DEFAULT_TWITTER_HANDLE,
    twitterCreator: DEFAULT_TWITTER_HANDLE,
    twitterTitle: "Sudoku Cyber-Matrix | Free Online Logic Number Puzzle — BHALYAM",
    twitterDescription: "Play neural 9x9 Sudoku logic puzzles across 4 difficulties online.",
    twitterImage: DEFAULT_OG_IMAGE,
    twitterImageAlt: "Sudoku Cyber-Matrix Game Board",
  },
  "/home": {
    path: "/home",
    canonical: `${BASE_URL}/`,
...
export const GAME_SOCIAL_METADATA: Record<string, GameSocialShareData> = {
  ...
  connect4: {
    game: "connect4",
    name: "Connect 4",
    shareTitle: "Connect 4 | Strategic 4-in-a-Row Disc Duel — BHALYAM",
    shareDescription: "Drop colored discs into the vertical grid and be the first to line up four in a row horizontally, vertically, or diagonally.",
    imageUrl: `${BASE_URL}/og/connect4.jpg`,
    imageWidth: "800",
    imageHeight: "533",
    imageType: "image/jpeg",
    imageAlt: "Connect 4 Vertical Disc Grid",
  },
  stargame: {
    game: "stargame",
    name: "Star Game",
  ...
  "2048": {
    game: "2048",
    name: "2048",
    shareTitle: "2048 Online | Fast Tile Sliding Number Puzzle — BHALYAM",
    shareDescription: "Slide tiles, combine numbers, and race to 2048! Multiple modes including Race and Time Attack.",
    imageUrl: DEFAULT_OG_IMAGE,
    imageWidth: DEFAULT_OG_WIDTH,
    imageHeight: DEFAULT_OG_HEIGHT,
    imageType: DEFAULT_OG_TYPE,
    imageAlt: "2048 Tile Sliding Game Board",
  },
  sudoku: {
    game: "sudoku",
    name: "Sudoku",
    shareTitle: "Sudoku Cyber-Matrix | Daily Neural Logic Puzzle — BHALYAM",
    shareDescription: "Challenge your mind with 9x9 Sudoku in futuristic Cyber-Matrix styling with 4 difficulty levels.",
    imageUrl: DEFAULT_OG_IMAGE,
    imageWidth: DEFAULT_OG_WIDTH,
    imageHeight: DEFAULT_OG_HEIGHT,
    imageType: DEFAULT_OG_TYPE,
    imageAlt: "Sudoku Cyber-Matrix Game Board",
  },
};
