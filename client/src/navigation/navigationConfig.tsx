    ...
    items: [
      {
        ...
        path: "/profile",
        hash: "#sec-profile",
        isActive: (p, _, h) => p === "/profile" && (!h || h === "" || h === "#sec-profile"),
      },
      {
        id: "profile-personal",
        ...
        path: "/profile",
        hash: "#sec-avatar",
        isActive: (p, _, h) => p === "/profile" && h === "#sec-avatar",
      },
      {
        id: "profile-stats",
        ...
        path: "/profile",
        hash: "#sec-data",
        isActive: (p, _, h) => p === "/profile" && h === "#sec-data",
      },
      {
      ...
      },
      {
        ...
        icon: Sliders,
        path: "/profile",
        hash: "#sec-preferences",
        isActive: (p, _, h) => p === "/profile" && h === "#sec-preferences",
      },
      {
        id: "profile-security",
        label: "Security",
        ...
        path: "/profile",
        hash: "#sec-account",
        isActive: (p, _, h) => p === "/profile" && h === "#sec-account",
      },
    ],
  },
