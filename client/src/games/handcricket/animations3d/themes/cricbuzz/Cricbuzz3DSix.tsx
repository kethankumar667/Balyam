...
export function Cricbuzz3DSix({
  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-center select-none">
      <div className="inline-flex items-center gap-2 rounded-full bg-[#00B38A]/20 border border-[#00B38A]/50 px-4 py-1 text-xs font-mono font-bold text-[#34D399] uppercase tracking-widest mb-2 animate-pulse">
        <span>🚀 HAWK-EYE DISTANCE: 106 METERS</span>
      </div>
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(180deg, #A7F3D0 0%, #00B38A 50%, #065F46 100%)",
      ...
      <div className="mt-3 inline-flex items-center gap-3 rounded-xl border border-[#00B38A]/40 bg-[#0E1815]/95 px-6 py-2.5 shadow-2xl backdrop-blur-md">
        ...
        <span className="text-xs sm:text-sm font-bold text-white/90">
          {message ?? "Deposited into the top tier!"}
        </span>
      </div>
    </div>
  );
