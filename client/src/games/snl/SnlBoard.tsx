...
import SnlBoardMobile from "./SnlBoardMobile";
import SnlBoardDesktop from "./SnlBoardDesktop";
import type { SnlBoardProps } from "./useSnlBoard";
...
export default function SnlBoard(props: SnlBoardProps) {
  ...
  return isDesktop ? <SnlBoardDesktop {...props} /> : <SnlBoardMobile {...props} />;
}
