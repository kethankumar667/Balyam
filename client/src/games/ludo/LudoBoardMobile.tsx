 ...
 * Ludo — mobile shell.
 *
 * Single column, touch-first: status bar → room rail → dice tray (stacks
 * vertically below `sm`) → board (capped by viewport width AND height so it
 * never needs scrolling) → all modals/overlays.
 */
