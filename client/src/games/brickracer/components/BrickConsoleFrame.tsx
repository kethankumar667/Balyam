...
export function BrickConsoleFrame({ children }: BrickConsoleFrameProps) {
  return (
    <div className="relative flex flex-col items-center bg-[#E4B128] border-4 border-[#9E7307] rounded-[44px] p-5 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6),inset_0_2px_6px_rgba(255,255,255,0.4)] max-w-md w-full mx-auto select-none">
