 ...
 * Check Animation.
 */
export function ChessCheckOverlay({ onComplete }: { onComplete?: () => void }) {
  useEffect(() => {
    fireStarSparkleBurst({ left: "50%", top: "45%" }, { intensity: 0.7 });
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-40 flex items-center justify-center">
      ...
      >
        ...
        <ComicBurstText text="CHECK!" accent="#881337" fill="#FECDD3" seed={61} />
        <div className="px-3.5 py-1 rounded-full text-xs font-black text-white bg-rose-700 border-2 border-rose-950 shadow-xl tracking-wider uppercase">
          King Under Attack!
        </div>
      </motion.div>
    </div>
...
/**
 * Chess Checkmate Winner Celebration — L4 Grandmaster Ceremony.
 */
export function ChessWinnerCelebration({
  winnerName,
}: {
  winnerName: string;
}) {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <ComicBurstText text="CHECKMATE!" accent="#1E293B" fill="#FDE047" seed={67} />
