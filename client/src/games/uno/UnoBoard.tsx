...
import UnoBoardMobile from "./UnoBoardMobile";
import UnoBoardDesktop from "./UnoBoardDesktop";
import type { UnoBoardProps } from "./useUnoBoard";
...
export default function UnoBoard(props: UnoBoardProps) {
