    ...
    <div className="min-h-[calc(100vh-6rem)] max-w-6xl mx-auto p-6 text-ink-hi font-sans grid grid-cols-12 gap-6">
      ...
      <div className="col-span-7 space-y-6 flex flex-col justify-between">
        ...
        <div className="bg-surface-0 border border-amber-500/30 rounded-2xl p-6 shadow-xl space-y-3">
          ...
          <div className="p-4 bg-amber-500/10 dark:bg-amber-950/40 border border-amber-500/30 rounded-xl">
            <h1 className="text-3xl font-bold text-amber-900 dark:text-amber-200 font-display">
              {q?.proverb || "సామెత..."}
            </h1>
            <p className="text-sm text-amber-800 dark:text-amber-100/70 mt-2 font-medium">{q?.prompt}</p>
          </div>
        </div>
        ...
        {state.phase === "playing" && q && (
          <div className="bg-surface-0 border border-surface-rim rounded-2xl p-6 shadow-xl space-y-4 flex-1 flex flex-col justify-between">
            ...
            {hasAnswered && (
              <div className="p-4 bg-amber-500/15 border border-amber-500/30 rounded-xl text-center">
