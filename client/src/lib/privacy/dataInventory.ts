...
export const DATA_INVENTORY: readonly InventoryEntry[] = [
  ...
  {
    key: "bhalyam.reduce_motion",
    label: "Reduce motion",
    description: "Whether UI animations and floating particle effects are minimized, from Settings > Preferences.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
    key: "bhalyam.auto_start",
    label: "Auto-start next round",
    description: "Whether rematch countdowns are accepted automatically once every player is ready.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
    key: "bhalyam.turn_warning",
    label: "Turn time warning",
    description: "Whether the screen border pulses when your turn timer drops below 10 seconds.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
    key: "bhalyam.online_status",
    label: "Online status visibility",
    description: "Whether friends and room players are allowed to see when you are active.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
  ...
  {
    key: "bhalyam.connect4.muted",
    label: "Connect 4 sound off",
    description: "Whether you muted the Connect 4 sound effects on this device.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
    key: "bhalyam.connect4.theme",
    label: "Connect 4 visual theme",
    description: "The cosmetic board skin you chose for Connect 4 on this device.",
    purpose: "preference",
    isPersonalData: false,
  },
  {
