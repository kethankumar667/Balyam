...
export const DICE_SKINS: Record<string, DiceSkinConfig> = {
  ...
  dice_porcelain_gold: {
    id: "dice_porcelain_gold",
    wooden: false,
    faceBg: "linear-gradient(135deg, #FFFFFF 0%, #F5F2EB 60%, #E6DEC8 100%)",
    faceBorder: "#D4AF37",
    pipBg: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.4), 0 1px 1px rgba(254,243,199,0.9)",
    glow: "0 0 16px rgba(212,175,55,0.4)",
    imageSrc: "/dice-skins/dice_porcelain_gold.webp",
  },
  dice_obsidian_gold: {
    id: "dice_obsidian_gold",
    wooden: false,
    faceBg: "linear-gradient(135deg, #1C1917 0%, #0C0A09 60%, #000000 100%)",
    faceBorder: "#F59E0B",
    pipBg: "linear-gradient(135deg, #FDE047 0%, #D97706 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.5), 0 0 4px rgba(245,158,11,0.8)",
    glow: "0 0 18px rgba(245,158,11,0.5)",
    imageSrc: "/dice-skins/dice_obsidian_gold.webp",
  },
  dice_faceted_diamond: {
    id: "dice_faceted_diamond",
    wooden: false,
    faceBg: "linear-gradient(135deg, #F8FAFC 0%, #E2E8F0 50%, #CBD5E1 100%)",
    faceBorder: "#94A3B8",
    pipBg: "linear-gradient(135deg, #F59E0B 0%, #B45309 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.4), 0 0 6px rgba(245,158,11,0.6)",
    glow: "0 0 20px rgba(148,163,184,0.6)",
    imageSrc: "/dice-skins/dice_faceted_diamond.webp",
  },
  dice_brushed_brass: {
    id: "dice_brushed_brass",
    wooden: false,
    faceBg: "linear-gradient(135deg, #D4AF37 0%, #AA820A 60%, #785A00 100%)",
    faceBorder: "#543E00",
    pipBg: "linear-gradient(135deg, #2A1D00 0%, #150E00 100%)",
    pipBorder: "inset 0 1.5px 2px rgba(0,0,0,0.8), 0 1px 1px rgba(254,243,199,0.4)",
    glow: "0 0 14px rgba(212,175,55,0.45)",
    imageSrc: "/dice-skins/dice_brushed_brass.webp",
  },
  dice_ruby_gemstone: {
    id: "dice_ruby_gemstone",
    wooden: false,
    faceBg: "linear-gradient(135deg, #EF4444 0%, #B91C1C 55%, #7F1D1D 100%)",
    faceBorder: "#FCA5A5",
    pipBg: "linear-gradient(135deg, #FEF08A 0%, #F59E0B 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.4), 0 0 6px rgba(254,240,138,0.9)",
    glow: "0 0 22px rgba(239,68,68,0.7)",
    imageSrc: "/dice-skins/dice_ruby_gemstone.webp",
  },
  dice_sapphire_crystal: {
    id: "dice_sapphire_crystal",
    wooden: false,
    faceBg: "linear-gradient(135deg, #3B82F6 0%, #1D4ED8 55%, #1E3A8A 100%)",
    faceBorder: "#93C5FD",
    pipBg: "linear-gradient(135deg, #FEF08A 0%, #F59E0B 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.4), 0 0 6px rgba(254,240,138,0.9)",
    glow: "0 0 22px rgba(59,130,246,0.7)",
    imageSrc: "/dice-skins/dice_sapphire_crystal.webp",
  },
  dice_black_gold_marble: {
    id: "dice_black_gold_marble",
    wooden: false,
    faceBg: "linear-gradient(135deg, #18181B 0%, #0A0A0B 60%, #000000 100%)",
    faceBorder: "#EAB308",
    pipBg: "linear-gradient(135deg, #FDE047 0%, #CA8A04 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.7), 0 0 5px rgba(234,179,8,0.8)",
    glow: "0 0 20px rgba(234,179,8,0.55)",
    imageSrc: "/dice-skins/dice_black_gold_marble.webp",
  },
  dice_carved_walnut: {
    id: "dice_carved_walnut",
    wooden: true,
    faceBg: "linear-gradient(135deg, #78350F 0%, #451A03 65%, #290E02 100%)",
    faceBorder: "#270E02",
    pipBg: "linear-gradient(135deg, #1C0A01 0%, #0A0400 100%)",
    pipBorder: "inset 0 1.5px 2px rgba(0,0,0,0.85), 0 0.5px 1px rgba(254,215,170,0.3)",
    glow: "0 0 12px rgba(120,53,15,0.4)",
    imageSrc: "/dice-skins/dice_carved_walnut.webp",
  },
  dice_cyber_neon_tron: {
    id: "dice_cyber_neon_tron",
    wooden: false,
    faceBg: "linear-gradient(135deg, #09090B 0%, #030712 100%)",
    faceBorder: "#22D3EE",
    pipBg: "linear-gradient(135deg, #67E8F9 0%, #06B6D4 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.8), 0 0 8px rgba(34,211,238,1)",
    glow: "0 0 24px rgba(6,182,212,0.8)",
    imageSrc: "/dice-skins/dice_cyber_neon_tron.webp",
  },
  dice_carrara_white_marble: {
    id: "dice_carrara_white_marble",
    wooden: false,
    faceBg: "linear-gradient(135deg, #FFFFFF 0%, #F1F5F9 60%, #E2E8F0 100%)",
    faceBorder: "#CBD5E1",
    pipBg: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.3), 0 1px 1px rgba(254,243,199,0.8)",
    glow: "0 0 16px rgba(203,213,225,0.5)",
    imageSrc: "/dice-skins/dice_carrara_white_marble.webp",
  },
  dice_cosmic_nebula: {
    id: "dice_cosmic_nebula",
    wooden: false,
    faceBg: "linear-gradient(135deg, #581C87 0%, #3B0764 55%, #0F021B 100%)",
    faceBorder: "#C084FC",
    pipBg: "linear-gradient(135deg, #FDE047 0%, #F59E0B 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.5), 0 0 7px rgba(253,224,71,0.9)",
    glow: "0 0 25px rgba(168,85,247,0.7)",
    imageSrc: "/dice-skins/dice_cosmic_nebula.webp",
  },
  dice_dragon_carbon_gold: {
    id: "dice_dragon_carbon_gold",
    wooden: false,
    faceBg: "linear-gradient(135deg, #27272A 0%, #18181B 50%, #09090B 100%)",
    faceBorder: "#EAB308",
    pipBg: "linear-gradient(135deg, #FDE047 0%, #CA8A04 100%)",
    pipBorder: "inset 0 1px 2px rgba(0,0,0,0.8), 0 0 6px rgba(234,179,8,0.9)",
    glow: "0 0 22px rgba(234,179,8,0.6)",
    imageSrc: "/dice-skins/dice_dragon_carbon_gold.webp",
  },
};
...
// ── 3. Token Skins (Ludo & Snakes and Ladders) ──
...
export interface TokenSkinConfig {
  ...
  imageSrc?: string;
  glowColor?: string;
  pedestalStyle?: "gold" | "silver" | "bronze" | "chrome" | "obsidian";
}
...
export const TOKEN_SKINS: Record<string, TokenSkinConfig> = {
  ...
  token_glossy_ruby: {
    id: "token_glossy_ruby",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_glossy_ruby.webp",
    glowColor: "#EF4444",
    pedestalStyle: "gold",
  },
  token_sapphire_glass: {
    id: "token_sapphire_glass",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_sapphire_glass.webp",
    glowColor: "#3B82F6",
    pedestalStyle: "gold",
  },
  token_faceted_emerald: {
    id: "token_faceted_emerald",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_faceted_emerald.webp",
    glowColor: "#10B981",
    pedestalStyle: "gold",
  },
  token_amber_topaz: {
    id: "token_amber_topaz",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_amber_topaz.webp",
    glowColor: "#F59E0B",
    pedestalStyle: "gold",
  },
  token_faceted_amethyst: {
    id: "token_faceted_amethyst",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_faceted_amethyst.webp",
    glowColor: "#A855F7",
    pedestalStyle: "gold",
  },
  token_mother_of_pearl: {
    id: "token_mother_of_pearl",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_mother_of_pearl.webp",
    glowColor: "#E2E8F0",
    pedestalStyle: "gold",
  },
  token_piano_obsidian: {
    id: "token_piano_obsidian",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_piano_obsidian.webp",
    glowColor: "#F59E0B",
    pedestalStyle: "gold",
  },
  token_faceted_ruby: {
    id: "token_faceted_ruby",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_faceted_ruby.webp",
    glowColor: "#DC2626",
    pedestalStyle: "gold",
  },
  token_faceted_cobalt: {
    id: "token_faceted_cobalt",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_faceted_cobalt.webp",
    glowColor: "#2563EB",
    pedestalStyle: "gold",
  },
  token_green_malachite: {
    id: "token_green_malachite",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_green_malachite.webp",
    glowColor: "#059669",
    pedestalStyle: "gold",
  },
  token_carved_walnut: {
    id: "token_carved_walnut",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_carved_walnut.webp",
    glowColor: "#D97706",
    pedestalStyle: "gold",
  },
  token_polished_chrome: {
    id: "token_polished_chrome",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_polished_chrome.webp",
    glowColor: "#94A3B8",
    pedestalStyle: "chrome",
  },
  token_matte_slate: {
    id: "token_matte_slate",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_matte_slate.webp",
    glowColor: "#F59E0B",
    pedestalStyle: "gold",
  },
  token_imperial_filigree: {
    id: "token_imperial_filigree",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_imperial_filigree.webp",
    glowColor: "#EAB308",
    pedestalStyle: "gold",
  },
  token_rainbow_titanium: {
    id: "token_rainbow_titanium",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_rainbow_titanium.webp",
    glowColor: "#EC4899",
    pedestalStyle: "gold",
  },
  token_glacier_ice: {
    id: "token_glacier_ice",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_glacier_ice.webp",
    glowColor: "#38BDF8",
    pedestalStyle: "silver",
  },
  token_molten_magma: {
    id: "token_molten_magma",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_molten_magma.webp",
    glowColor: "#EA580C",
    pedestalStyle: "obsidian",
  },
  token_rose_quartz: {
    id: "token_rose_quartz",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_rose_quartz.webp",
    glowColor: "#F472B6",
    pedestalStyle: "gold",
  },
  token_cosmic_galaxy: {
    id: "token_cosmic_galaxy",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_cosmic_galaxy.webp",
    glowColor: "#818CF8",
    pedestalStyle: "gold",
  },
  token_calacatta_marble: {
    id: "token_calacatta_marble",
    hasCrown: false,
    hasFireball: false,
    hasNeonRing: false,
    hasDiamond: false,
    hasPhoenixWing: false,
    imageSrc: "/token-skins/token_calacatta_marble.webp",
    glowColor: "#FDE047",
    pedestalStyle: "gold",
  },
};
