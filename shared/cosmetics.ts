...
export const BHALYAM_COSMETIC_REGISTRY: readonly RegistryCosmeticDef[] = [
  ...
  { id: "dice_porcelain_gold", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_porcelain_gold.webp", isDefault: false },
  { id: "dice_obsidian_gold", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_obsidian_gold.webp", isDefault: false },
  { id: "dice_faceted_diamond", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_faceted_diamond.webp", isDefault: false },
  { id: "dice_brushed_brass", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_brushed_brass.webp", isDefault: false },
  { id: "dice_ruby_gemstone", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_ruby_gemstone.webp", isDefault: false },
  { id: "dice_sapphire_crystal", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_sapphire_crystal.webp", isDefault: false },
  { id: "dice_black_gold_marble", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_black_gold_marble.webp", isDefault: false },
  { id: "dice_carved_walnut", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_carved_walnut.webp", isDefault: false },
  { id: "dice_cyber_neon_tron", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_cyber_neon_tron.webp", isDefault: false },
  { id: "dice_carrara_white_marble", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_carrara_white_marble.webp", isDefault: false },
  { id: "dice_cosmic_nebula", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_cosmic_nebula.webp", isDefault: false },
  { id: "dice_dragon_carbon_gold", category: "DICE_SKIN", supportedScopes: ["GLOBAL", "ludo", "snl"], bundledAssetKey: "/dice-skins/dice_dragon_carbon_gold.webp", isDefault: false },

  // ── Token Skins (Ludo & SnS) ──
  {
    id: "token_classic_pawn",
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo", "snl", "GLOBAL"],
  ...
  { id: "token_glossy_ruby", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_glossy_ruby.webp", isDefault: false },
  { id: "token_sapphire_glass", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_sapphire_glass.webp", isDefault: false },
  { id: "token_faceted_emerald", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_faceted_emerald.webp", isDefault: false },
  { id: "token_amber_topaz", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_amber_topaz.webp", isDefault: false },
  { id: "token_faceted_amethyst", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_faceted_amethyst.webp", isDefault: false },
  { id: "token_mother_of_pearl", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_mother_of_pearl.webp", isDefault: false },
  { id: "token_piano_obsidian", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_piano_obsidian.webp", isDefault: false },
  { id: "token_faceted_ruby", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_faceted_ruby.webp", isDefault: false },
  { id: "token_faceted_cobalt", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_faceted_cobalt.webp", isDefault: false },
  { id: "token_green_malachite", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_green_malachite.webp", isDefault: false },
  { id: "token_carved_walnut", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_carved_walnut.webp", isDefault: false },
  { id: "token_polished_chrome", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_polished_chrome.webp", isDefault: false },
  { id: "token_matte_slate", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_matte_slate.webp", isDefault: false },
  { id: "token_imperial_filigree", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_imperial_filigree.webp", isDefault: false },
  { id: "token_rainbow_titanium", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_rainbow_titanium.webp", isDefault: false },
  { id: "token_glacier_ice", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_glacier_ice.webp", isDefault: false },
  { id: "token_molten_magma", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_molten_magma.webp", isDefault: false },
  { id: "token_rose_quartz", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_rose_quartz.webp", isDefault: false },
  { id: "token_cosmic_galaxy", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_cosmic_galaxy.webp", isDefault: false },
  { id: "token_calacatta_marble", category: "TOKEN_SKIN", supportedScopes: ["ludo", "snl", "GLOBAL"], bundledAssetKey: "/token-skins/token_calacatta_marble.webp", isDefault: false },
...
export function resolveEffectiveLoadout(
  ...
  return {
    ...
    tokenSkins: {
      ...
      ludo: sanitizedOrDefault(
        equipped?.tokenSkins?.ludo,
        "TOKEN_SKIN",
        "ludo",
        sanitizedOrDefault(equipped?.tokenSkins?.GLOBAL, "TOKEN_SKIN", "GLOBAL", defaultToken),
      ),
      snl: sanitizedOrDefault(
        equipped?.tokenSkins?.snl,
        "TOKEN_SKIN",
        "snl",
        sanitizedOrDefault(equipped?.tokenSkins?.GLOBAL, "TOKEN_SKIN", "GLOBAL", defaultToken),
      ),
