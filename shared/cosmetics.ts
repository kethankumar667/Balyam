...
export const BHALYAM_COSMETIC_REGISTRY: readonly RegistryCosmeticDef[] = [
  ...
  // ── Token Skins (Ludo) — character-themed accessories, 2026-09-15.
  // Icon carries fixed signature colors; the pawn body stays seat-colored. ──
  {
    id: "token_theme_ninja",
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-ninja",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-thunder-hammer",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-super-hero",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-arcane-wizard",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-star-voyager",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-dragon-knight",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-pirate-captain",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-cyber-bot",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-samurai",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-vampire-count",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-desert-sultan",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-arctic-ranger",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-steam-inventor",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-jungle-scout",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-imperial-general",
    isDefault: false,
  },
  {
    ...
    category: "TOKEN_SKIN",
    supportedScopes: ["ludo"],
    bundledAssetKey: "token-theme-void-reaper",
    isDefault: false,
  },
